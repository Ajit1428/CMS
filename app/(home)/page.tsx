...
const HomePage = () => {
  ...
  return (
    <div className="h-full flex items-center bg-blue-400 justify-center">
      <div className="border-solid border-2 rounded-xl bg-gradient-to-br mb-[100px] from-white from-40% to-yellow-200 overflow-hidden border-yellow-400 p-4 shadow-xl w-[370px] gap-y-6 flex flex-col items-center text-start justify-center">
